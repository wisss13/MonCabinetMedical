...
public class GroupsFragment extends ListContactFragment implements RecyclerViewOnClickListenerHack, View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        iv_settings.setImageResource(R.drawable.ic_account_multiple_plus_white);
        mToolbarButton.inflateMenu(R.menu.menu_bottom);
        mToolbarButton.findViewById(R.id.iv_settings).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(getContext(), "Add new Group pressed", Toast.LENGTH_SHORT).show();
            }
        });

        mRecyclerView = (RecyclerView) rootView.findViewById(R.id.listGroups);
